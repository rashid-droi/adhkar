...
class SurahMulkPage extends StatelessWidget {
  // Complete Arabic text for Surah Al-Mulk (Verses 1-30)
...
child: Scrollbar(
  ...
  thickness: 3,  // Reduced thickness for a more subtle look
  radius: const Radius.circular(10),  // More rounded corners
  child: SingleChildScrollView(
    padding: const EdgeInsets.only(right: 1),  // Add some padding for better spacing
    child: Column(
                    children: [
                      Text(
                        bigText,
