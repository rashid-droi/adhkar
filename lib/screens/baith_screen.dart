...
class BaithScreen extends StatelessWidget {
  const BaithScreen({super.key});
  ...
  final List<String> buttonTitles = const [
    ...
    'Salam Baith',
    'Swallal Ilah Baith',
    'Tawassul Bi Shamsul Ulama(r)',
    'Thawassul Bi davoodul Hakeem(r)',
    'Thwalal Badru Baith',
    'Ya Akrama Baith',
    'Ya Sayyidee Baith',
  ];
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Add navigation or action for each Baith
              },
